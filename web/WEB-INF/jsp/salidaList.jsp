                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
                                <h6 class="m-0 font-weight-bold text-gray-800">Salidas</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <form>                                                           
                                                                ...
                                                                <p>
                                                                    <label for="exampleFormControlInput1">Monto Total:</label>
                                                                    <input type="text" class="form-control" name="">
                                                                </p>
                                                                <p>
                                                                    <label for="exampleFormControlInput1">Vendido por:</label>
                                                                    <input type="text" class="form-control" name="">
                                                                </p>
                                                            </form>
                                                        </div>
