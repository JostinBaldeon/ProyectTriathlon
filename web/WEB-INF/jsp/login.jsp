                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="srvUsuario?accion=verificar" method="post">
                                        <div class="form-group">
                                            <input type="nombre_usu" class="form-control form-control-user"
                                                name="nombre_usu"
                                                placeholder="Ingrese tu usuario...">
                                        </div>
                                        <div class="form-group">
                                            <input type="clave_usu" class="form-control form-control-user"
                                                name="clave_usu" placeholder="Ingrese la contraseña...">
                                        </div>
