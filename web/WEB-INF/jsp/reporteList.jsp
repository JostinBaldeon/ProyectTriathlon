            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.jsp">
                    <div class="sidebar-brand-icon rotate-n-15">
                        <img src="img/logo.png" weight="72px" height="20px" alt="alt"/>
                    </div>
                    <div class="sidebar-brand-text mx-3">JOMA</div>
                </a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <form>
                                                                ...
                                                                <p>
                                                                    <label for="exampleFormControlInput1">Persona de Contacto:</label>
                                                                    <input type="text" class="form-control" name="">
                                                                </p>
                                                                <p>
                                                                    <label for="exampleFormControlInput1"># de Contacto:</label>
                                                                    <input type="text" class="form-control" name="">
                                                                </p>
                                                                <p>
