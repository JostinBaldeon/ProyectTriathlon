    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Nav Item - Tables -->
                <li class="nav-item">
                    <a class="nav-link" href="usuariosList.htm">
                ...
                <!-- Nav Item - Tables -->
                <li class="nav-item">
                    <a class="nav-link" href="reporteList.htm">
                        <i class="fas fa-users fa-table"></i>
                        <span>Reporte</span></a>
                </li>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Devoluciones
                                                </div>
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col-auto">
